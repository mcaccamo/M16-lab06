package edu.ucsb.cs56.drawings.dvanmali;
...
public class SimpleGui1 {
    ...
    */
	...
	JButton button = new JButton("Click Me To Stay Amazing") ;

	java.awt.Color myColor = new java.awt.Color(0,214,255);   // R, G, B values.
