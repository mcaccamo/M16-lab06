package edu.ucsb.cs56.drawings.j_hwang.simple;
...
/**
   ...
   @author Austin Jun Ho Hwang (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Drawing of a House and Snowman - Austin Jun Ho Hwang", 20,20);
